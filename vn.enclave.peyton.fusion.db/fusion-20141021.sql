...
CREATE TABLE `device_templates` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_device_templates_types_idx` (`idType`),
...
INSERT INTO `device_templates` VALUES (1,2,'Axis - Non-PTZ Models','2013-08-12 22:38:00','Axis','Non-PTZ Models','2.0.1','Cameras','Models 215PTZ, 212PTZ','\0');
...
CREATE TABLE `device_types` (
  ...
  CONSTRAINT `fk_device_types_modules` FOREIGN KEY (`idModule`) REFERENCES `modules` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `device_types` VALUES (1,1,'DVR/NVR'),(2,1,'IP Cameras');
...
INSERT INTO `modules` VALUES (1,'CCTV'),(2,'Fireplace');
...
-- Dump completed on 2014-10-21 16:59:45
